...
public class PlayerCollision : MonoBehaviour
{
    ...
    private void SetAnimatorByCollision(Collider collider)
    {
        ...
        //Empiezan las colisiones de tambaleos
    ...
    private void EventCollisionRight()
    {
        if (playerController.Position == Side.Middle)
        {
            playerController.Position = Side.Right;
            playerController.SetPlayerCollisionPOsition();
        }
        else if (playerController.Position == Side.Left)
        {


            playerController.Position = Side.Middle;
            playerController.SetPlayerCollisionPOsition();
        }
    }

    private void EventCollisionLeft()
    {
        if (playerController.Position == Side.Right)
        {
        ...
        else if (playerController.Position == Side.Middle)
        {
            new WaitForSeconds(2);
            playerController.Position = Side.Left;
            playerController.SetPlayerCollisionPOsition();
        }
    }
}
